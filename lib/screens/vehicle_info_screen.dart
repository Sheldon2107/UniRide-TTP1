...
import 'supporting_docs_screen.dart';
...
class _VehicleInfoScreenState extends State<VehicleInfoScreen> {
  ...
  static const List<String> _categories = ["Sedan", "SUV", "Hatchback"];
  ...
  void _onNext() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => SupportingDocsScreen(
        ...
        child: Column(
          ...
          children: [
            ...
            _InputField(
              ...
              hint: "Enter your vehicle's model name",
            ...
            _InputField(
              ...
              hint: "Enter your vehicle's number plate",
              onChanged: (_) => setState(() {}),
