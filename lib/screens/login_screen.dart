...
import 'constants.dart';           // Keep this if you still use AppColors elsewhere
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.background,   // or Colors.white if you prefer consistency
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  disabledBackgroundColor: AppColors.brandBlue.withOpacity(0.4),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              prefixIcon: Icon(icon, size: 20, color: AppColors.brandBlue),
              ...
              enabledBorder: UnderlineInputBorder(
                borderSide: BorderSide(color: AppColors.textSecondary.withOpacity(0.6)),
              ),
